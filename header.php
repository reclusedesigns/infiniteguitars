...
<head>
	...
	<title>Infinite Guitars</title>
	<meta name="author" content="Infinite Guitars">
	...
	<script src="design/vendor/ss-pika/ss-standard.js" type="text/javascript" charset="utf-8"></script>
		...
		<div class="navbar-inner">
			<div class="container">
		  	...
		  	<ul class="nav pull-right">
		  		...
		  		<li><a class="button" href="#">Sell your guitar</a></li>
		  	</ul>
			</div>
		</div>
	</div>